...
const concepts = [
  { id: "01", className: "palette-overcomers-red", lockupClass: "mission-logo-red" },
  { id: "02", className: "palette-overcomers-blue", lockupClass: "mission-logo-blue" },
  { id: "03", className: "palette-overcomers-orange", lockupClass: "mission-logo-orange" },
  { id: "04", className: "palette-overcomers-yellow", lockupClass: "mission-logo-yellow" },
  { id: "05", className: "palette-overcomers-green", lockupClass: "mission-logo-green" },
  { id: "06", className: "palette-white-violet", lockupClass: "mission-option-01" },
  { id: "07", className: "palette-white-blue", lockupClass: "mission-option-02" },
  { id: "08", className: "palette-brand-gold palette-logo-buttons", lockupClass: "mission-option-03", logoButtons: true },
  { id: "09", className: "palette-brand-bright palette-logo-buttons", lockupClass: "mission-option-04", logoButtons: true },
  { id: "10", className: "palette-brand-balanced palette-logo-buttons", lockupClass: "mission-option-05", logoButtons: true },
  { id: "11", className: "palette-turquoise", lockupClass: "mission-option-06" },
  { id: "12", className: "palette-lavender", lockupClass: "mission-option-07" },
  { id: "13", className: "palette-sunny", lockupClass: "mission-option-08" },
  { id: "14", className: "palette-green", lockupClass: "mission-option-09" },
  { id: "15", className: "palette-sky", lockupClass: "mission-option-10" },
  { id: "16", className: "palette-mint", lockupClass: "mission-option-11" },
  { id: "17", className: "palette-lemon", lockupClass: "mission-option-12" },
  { id: "18", className: "palette-lilac", lockupClass: "mission-option-13" },
  { id: "19", className: "palette-brand-gold", lockupClass: "mission-option-14" },
  { id: "20", className: "palette-brand-mix", lockupClass: "mission-option-15" },
];
